if get(g:, 'vim_usd_lint_loaded', 0) == 1
    finish
endif
...
"
nnoremap <silent> <Plug>VimUsdLintFormatCurrentBuffer :call vim_usd_lint#auto_format_current_buffer()<CR>

let g:vim_usd_lint_loaded = 1
